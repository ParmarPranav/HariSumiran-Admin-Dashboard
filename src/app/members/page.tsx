      ...
      {activeTab === "directory" ? (
        <>
            ...
            <div className="flex flex-col md:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-xl border border-stone-200 bg-stone-50 pl-10 pr-4 text-xs text-stone-900 focus:border-amber-500 focus:outline-none placeholder:text-stone-400"
                />
              </div>
          ...
          {loading ? (
            ...
            <GlassCard className="py-12 text-center text-xs text-stone-500 bg-white border-stone-200/90 shadow-sm">
              No members found matching your search.
            </GlassCard>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {members.map((member) => (
                <GlassCard key={member._id} hoverEffect className="space-y-3 flex flex-col justify-between bg-white border-stone-200/90 shadow-sm">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          alt={member.name}
                          className="h-12 w-12 rounded-2xl object-cover border border-stone-200 shadow-sm"
                        />
                        <div>
