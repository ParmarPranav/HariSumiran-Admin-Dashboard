...
export async function POST() {
  try {
    ...
    await Promise.all([
      ...
      ThalSwapRequest.deleteMany({}),
      KitchenRecipe.deleteMany({}),
      TravelRide.deleteMany({}),
    ...
    const [sabhas, sevaOpps] = await Promise.all([
      ...
      ThalSwapRequest.insertMany(initialThalSwapRequests),
      KitchenRecipe.insertMany(initialRecipes),
      TravelRide.insertMany(initialTravelRides),
    ...
    return NextResponse.json({
      ...
      counts: {
        ...
        travelRides: initialTravelRides.length,
